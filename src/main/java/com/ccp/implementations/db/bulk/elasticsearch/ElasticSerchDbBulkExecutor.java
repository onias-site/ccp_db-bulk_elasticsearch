...
enum ElasticSerchDbBulkExecutorConstants implements CcpJsonFieldName{
	items
}
...
class ElasticSerchDbBulkExecutor implements CcpDbBulkExecutor{
	...
	public List<CcpBulkOperationResult> getBulkOperationResult() {
		...
		List<CcpJsonRepresentation> items = executeHttpRequest.getAsJsonList(ElasticSerchDbBulkExecutorConstants.items);
